  ...
  cat > "$out" <<EOF
{
  ...
  "limits": {
    ...
    "requests_per_min_per_key": ${POLICY_RPM_KEY:-30},
    "max_in_flight_per_ip": ${POLICY_INFLIGHT_IP:-2},
    "max_context_tokens": ${POLICY_MAX_CTX:-8192},
    "max_output_tokens": ${POLICY_MAX_OUT:-2048},
    "max_prompt_chars": ${POLICY_MAX_PROMPT_CHARS:-32000},
